...
export const NEW_PLACE_LIST = "NEW_PLACE_LIST";
export const SUBMIT_PLACE_REQUEST = "SUBMIT_PLACE_REQUEST";
export const SUBMIT_PLACE_SUCCESS = "SUBMIT_PLACE_SUCCESS";
export const SUBMIT_PLACE_FAILURE = "SUBMIT_PLACE_FAILURE";
...
export const SUBMIT_CHAT_SUCCESS = "SUBMIT_CHAT_REQUEST";
export const SUBMIT_CHAT_FAILURE = "SUBMIT_CHAT_FAILURE";
